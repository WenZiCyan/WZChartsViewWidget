...
@interface WZColumnViewParams : NSObject <NSCopying,NSMutableCopying>
...
// 背景颜色列表
@property (strong, nonatomic) NSMutableArray<UIColor *> *colorRandom;
...
// 柱形偏移
@property (nonatomic) float lineDis;
